...
const VARIANTS = {
  primary: 'bg-emerald-600 hover:bg-emerald-700 text-white shadow-sm focus-visible:ring-emerald-500 border border-transparent',
  secondary: 'bg-white hover:bg-slate-50 text-slate-700 border border-slate-200 shadow-sm focus-visible:ring-slate-400',
  outline: 'bg-transparent hover:bg-emerald-50 text-emerald-600 border border-emerald-300 focus-visible:ring-emerald-500',
  amber: 'bg-amber-500 hover:bg-amber-600 text-white shadow-sm focus-visible:ring-amber-400 border border-transparent',
